...
class UserModel extends BaseModel
{
    ...
    public function getTeam(){
        ...
        if(!is_null($teamUser)) {
            return TeamModel::findOne(['team_id' => $teamUser->team_id]);
        } else {
            return null;
        }
    }
    ...
    public function getTeamUser(){
        return $this->hasOne(TeamUserModel::className(), [
            'user_id' => id
        ]);
    }
    ...
    public function updateInviteCode($inviteCode) {
        $this->setAttribute('invite_code', $inviteCode);
        return $this->save();
    }
