                    ...
                    <li>
                        <div id="my_route">
                            <p class="line1">
                                ...
                                <?=$teamModel->route_name ? :$teamModel->driver->userInfo->home_address.'-'.$teamModel->driver->userInfo->company_address?>
                            </p>
                            <p class="line2 exp"><span>时间：</span><span>
                                   <?=$teamModel->getClockTimeHour()?>:<?=$teamModel->getClockTimeMinutes()?>
                                </span>—<span><?=strlen($teamModel->driver->userInfo->off_duty_hour) == 1 ? 0: ''?>
                                    <?=$teamModel->getOffDutyHour()?>:<?=$teamModel->getOffDutyMinutes()?></span></p>
