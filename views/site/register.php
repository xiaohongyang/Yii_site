...
<!--******新增2016.12.12***********-->		
		<div id="free_mess">                             
                <span class="head">免费体验</span>
                <span class="close2"></span>
                <div class="content">
                    <p>尊敬的乘客（司机），你可以免费体验2天（司机10天），一但匹配路线成功，系统会短信通知你。</p>
                    <span class="ok" onclick="$('#w0').trigger('submit');">确定</span>
                </div>
