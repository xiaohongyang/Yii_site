...
<body>
    <div id="bg">
        ...
        <ul class="cont">
            <li>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;司机：</span><span><?=$teamModel->driver->weChat&&$teamModel->driver->weChat->nickname ? $teamModel->driver->weChat->nickname : $teamModel->driver->mobile?></span>
            </li>
            <li>
            ...
            <li>
             ...
             <li>
                <span>开车时间：</span><span><?=$teamModel->clockTimeHour.':'.$teamModel->clockTimeMinutes?></span>
                 —
                 <span><?=$teamModel->offDutyHour.':'.$teamModel->offDutyMinutes?></span>
            </li>
             <li>
