    ...
    <div id="bg">
        ...
        <ul class="cont">
            ...
            <li>
             ...
             <li>
                <span class="left">车门数：</span><span class="right">5</span>
            </li>
             <li>
                <span class="left">座位数：</span><span class="right">4</span>
            </li>
             <li>
            ...
            <li>
                <span class="left">长*宽*高(mm)：</span><span class="right">3598×1630×1595</span>
            </li>
             <li>
                <span class="left">车身结构：</span><span class="right">5门 4座 两厢轿车</span>
            </li>
        </ul>
