...
<body>
	...
	<div id="bg">
				...
				<form action="<?=\yii\helpers\Url::to('/site/login')?>" method="post">
					...
					<div id="content">
						<input type="text" name="mobile" maxlength="11" id="mobile" placeholder="<?=$model->mobile?:'请输入手机号'?>" value="<?=$model->mobile?:''?>">
						<span><a href="javascript:void(0)" id="btn-get-code">获取验证码</a></span>
						<div class="fenge"></div>
						<input type="text" name="code" placeholder="请输入短信验证码">
						<div class="fenge"></div>
						<input type="text" placeholder="请输入邀请码" name="invite_code" value="<?= Yii::$app->request->post('invite_code') ? : ''?>" />
					</div>
					<div id="login">
